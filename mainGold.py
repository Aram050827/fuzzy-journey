...
async def show_rules(update: Update, context: ContextTypes.DEFAULT_TYPE):
    rules = (
        ...
        "Խաղաքարտերի վրա 5 շարքով 3 տողերում և 8 սյունակներում տեղավորված են 15 պատահական թվեր,\n"
        "տասնյակները համապատասխանում են ձախ սյունակին՝ սկսած զրոյից, 80-ը տեղավորվում է վերջին սյունակում։\n"
        "Խաղը կայանում է նրանում, որ խաղացողները նշում են խաղաքարտի վրայի թվերը և հաղթում է այն խաղացողը, ով ամենաառաջինն է նշում բոլոր թվերը"
